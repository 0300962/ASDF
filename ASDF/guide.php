...
<div id="disclaimers">
    ...
    <div class="guide">
        ...
        allowing Admin users to change the priorities or add new PBIs.  Under the Performance tab, users can see the
        Project Burndown chart- this shows the overall progress for the project, in terms of how many PBI’s are left to
        complete after each Sprint.
    </div>
...
<div id="disclaimers">
    ...
    <div class="guide">
        <p>When you log-in to the system for the first time, you are required to set a password (minimum 8 characters,
            case-sensitive).  The next time you log-in, you’ll set up your profile information (see below). </p>
        <p>Across the system, wherever you see something like () or (), it’s something you can interact with.  If you
            want to log-out from ASDF, mouse-over your name in the upper-right of the page and click the link. </p>
    </div>
